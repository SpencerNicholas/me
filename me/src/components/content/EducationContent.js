  ...
  return (
    <div style={contentStyle}>
      ...
      <div style={navButtonsStyle}>
        <div onClick={() => { dispatch(setPage('EXPERIENCE')) }} onMouseOver={() => { dispatch(setHover('UpArrow')) }} onMouseLeave={() => { dispatch(setHover()) }}>
          {(hovering) === 11 ? (
        ...
        <div onClick={() => { dispatch(setPage('SKILLS')) }} onMouseOver={() => { dispatch(setHover('DownArrow')) }} onMouseLeave={() => { dispatch(setHover()) }}>
          {(hovering) === 10 ? (
