  ...
  return (
    <div style={contentStyle}>
      ...
      <div style={navButtonsStyle}>
        <div onClick={() => { dispatch(setPage('ABOUT')) }} onMouseOver={() => { dispatch(setHover('UpArrow')) }} onMouseLeave={() => { dispatch(setHover()) }}>
          {(hovering) === 11 ? (
        ...
        <div onClick={() => { dispatch(setPage('EDUCATION')) }} onMouseOver={() => { dispatch(setHover('DownArrow')) }} onMouseLeave={() => { dispatch(setHover()) }}>
          {(hovering) === 10 ? (
